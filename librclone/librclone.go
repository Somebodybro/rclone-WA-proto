...
//
//	go build --buildmode=c-shared -o librclone.so github.com/Somebodybro/rclone-WA-proto/librclone
//
// Build a static library like this:
//
//	go build --buildmode=c-archive -o librclone.a github.com/Somebodybro/rclone-WA-proto/librclone
//
...
import (
	...
	"github.com/Somebodybro/rclone-WA-proto/librclone/librclone"

	_ "github.com/Somebodybro/rclone-WA-proto/backend/all"   // import all backends
	_ "github.com/Somebodybro/rclone-WA-proto/cmd/cmount"    // import cmount
	_ "github.com/Somebodybro/rclone-WA-proto/cmd/mount"     // import mount
	_ "github.com/Somebodybro/rclone-WA-proto/cmd/mount2"    // import mount2
	_ "github.com/Somebodybro/rclone-WA-proto/fs/operations" // import operations/* rc commands
	_ "github.com/Somebodybro/rclone-WA-proto/fs/sync"       // import sync/*
