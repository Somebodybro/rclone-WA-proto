...
<tr><th>Branch</th><td><a href="https://github.com/Somebodybro/rclone-WA-proto/tree/{{ .Branch }}">{{ .Branch }}</a></td></tr>
{{ if .Commit}}<tr><th>Commit</th><td><a href="https://github.com/Somebodybro/rclone-WA-proto/commit/{{ .Commit }}">{{ .Commit }}</a></td></tr>{{ end }}
